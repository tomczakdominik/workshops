...
describe ProductsController do
  ...
  let(:valid_attributes) { { "title" => "MyString", "category_id" => category.id, "price" => '100.00', 'description' => 'MyDescription', 'user_id' => signed_user.id } }
  let(:user_attributes) { { "email" => "test@test.test", "firstname" => "price", 'lastname' => 'MyDescription', 'password' => 'MyPassNotToShort' } }
  let(:user_attributes2) { { "email" => "test2@test.test", "firstname" => "price", 'lastname' => 'MyDescription', 'password' => 'MyPassNotToShort' } }
    ...
    describe "GET edit" do
      describe "with valid params" do
        ...
        it "renders error message" do
          ...
          # expect(controller.flash[:alert]).to eq "You are not allowed to edit this product."
        end
      end
    end
